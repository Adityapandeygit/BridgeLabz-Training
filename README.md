...
> 🔗 [Browse Static, This, Final & Instanceof programs](https://github.com/Adityapandeygit/BridgeLabz-Training/tree/oops-practice/oops-practice/gcr-codebase/static-this-final-instanceOf)
...
> 🔗 [Browse Inheritance and Polymorphism programs](https://github.com/Adityapandeygit/BridgeLabz-Training/tree/oops-practice/oops-practice/gcr-codebase/inheritance-polymorphism-interface)
...
> 🔗 [Browse Encapsulation and Polymorphism programs](https://github.com/Adityapandeygit/BridgeLabz-Training/tree/oops-practice/oops-practice/gcr-codebase/encapsulation-abstraction-interface)
...
**GitHub Repository:** [https://github.com/Adityapandeygit/BridgeLabz-Training](https://github.com/Adityapandeygit/BridgeLabz-Training)
...
```bash
git clone https://github.com/Adityapandeygit/BridgeLabz-Training.git
cd BridgeLabs-Training
```

### Running Java Programs

Navigate to the specific program directory and compile the Java file:

```bash
# For basic programs
cd core-java-practice/gcr-codebase/programming-elements/
javac Filename.java
java Filename
```
